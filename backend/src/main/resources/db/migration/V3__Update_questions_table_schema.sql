...
-- 1. Fix cefrLevel column size from varchar(5) to varchar(20)
ALTER TABLE questions
  ALTER COLUMN cefr_level TYPE varchar(20);

-- 2. Increase correctAnswer column size from varchar(50) to varchar(100)
ALTER TABLE questions
...
-- - correct_answer: varchar(100) for longer answer texts
